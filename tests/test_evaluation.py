...
from baspr.interpretation.annotations import build_annotation_summary
...
def test_age_benchmark_runs_with_generated_manifest(tmp_path, observed_tables_eval) -> None:
    ...
    manifest_path = _write_generated_manifest(tmp_path, series_name="baspr", tables=generated_tables)
    ...
    assert "baspr" in result.summary["sources"]
