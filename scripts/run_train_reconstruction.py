...
from baspr.config import PaperConfig
from baspr.io.loaders import align_feature_columns, load_feature_list, load_observed_tables
from baspr.io.manifest import DataManifest
from baspr.preprocessing.normalize import normalize_tables
from baspr.reconstruction.dataset import build_pair_arrays
from baspr.reconstruction.train import train_reconstruction_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the BaSPR reconstruction model.")
    ...
    parser.add_argument("--mode", choices=["baspr", "baseline_only", "key_only"], default="baspr")
