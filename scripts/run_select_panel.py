...
from baspr.io.loaders import align_feature_columns, load_observed_tables
from baspr.io.manifest import DataManifest
from baspr.preprocessing.normalize import normalize_tables
from baspr.selection.init_panel import initialize_panel, save_panel
from baspr.selection.sparse_prune import iterative_sparse_prune, save_sparse_prune_result


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the paper-core BaSPR panel selection pipeline.")
