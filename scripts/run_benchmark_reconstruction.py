...
from baspr.io.loaders import load_observed_tables
from baspr.io.manifest import DataManifest
from baspr.reconstruction.benchmark import benchmark_reconstruction_modes


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark BaSPR reconstruction against observed future visits.")
